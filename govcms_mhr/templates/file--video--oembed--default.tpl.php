...
<div id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    ?>
    <?php if (isset($video_id) && !empty($video_id) && $video_provider == "youtube") : ?>
      <iframe width="640" height="360" src="https://www.youtube.com/embed/<?php print $video_id?>?feature=oembed&rel=0&showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>
    <?php else : ?>
