...
<div id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    if (isset($video_id) && !empty($video_id) && $video_provider == "youtube") {; ?>
      <a href="https://www.youtube.com/embed/<?php print $video_id?>?autoplay=1&rel=0&showinfo=0" class="colorbox-video" title="Video: <?php print $label; ?>"><?php print render($content);?></a>
    <?php
      } else {
